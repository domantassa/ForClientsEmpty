...
@section('content')
    ...
    <div class="bg-body-light">
        <div class="" >
            ...
            <a style="position:absolute;top:<?php echo(405/16);?>rem;left:<?php echo(25/16);?>rem;color:red;width:<?php echo(320/16);?>rem;height:<?php echo(40/16);?>rem;" href="{{route('rate')}}"></a>
            </div>
