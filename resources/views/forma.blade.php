            ...
            <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
                    ...
                    <div id="uzklausos_forma">
                       <div class="custom-form-group-1">
                            ...
                            <option>Šunų dresavimas</option >
                                <option>Apgyvendinimas</option >
                                <option>Transportas</option >   
                                <option selected>Paslaugos kategorija</option >  
                                </select>
                        </div>

                        <div class="custom-form-group-1">
                                <input type="text" placeholder="Biudžetas" name="title" class=" btn-round order-btn-grey form-btn form-btn2" >
                        </div>

                        <div class="custom-form-group-1">
                                <input type="text" placeholder="Jūsų buvimo vieta" name="title" class=" btn-round order-btn-grey form-btn form-btn2" >
                        </div>

                        <div class="custom-form-group">
                                <textarea rows="3" name="feedback" class=" btn-round order-btn-grey form-btn " placeholder="Poreikių aprašymas"></textarea>
                        </div>
                        <div class="custom-form-group">
